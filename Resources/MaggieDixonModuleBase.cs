...
namespace DotNetNuke.Modules.MaggieDixon
{
    ...
    /// are accessible to your module's controls (that inherity from MaggieDixonModuleBase
    /// 
    /// </summary>

    public class MaggieDixonModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
